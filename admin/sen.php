...
<form action="auth_new_sen.php" method="get">
          <div style="margin-top: 30px;margin-left: 100px;">
<p>Sentence Structure</p>
            <ons-select id="choose-sel" name="structure">

                <?php

                $sql = "SELECT * FROM SENSTRU ORDER BY struct_id DESC";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                      ...
                      $string = "<option value=\"".$row["struct_id"]."\">".$row["struct_id"]." - ".$row["struct"]."</option>";
...
<br>
              <p>
                <ons-input id="username" modifier="underbar" name = "sentence" placeholder="Word" float autofocus></ons-input>
              </p><br>
              

              <p style="margin-top: 30px;">
                <input type="submit" value="ADD SENTENCE" class="form-submit-button">
              </p>
            </div>
