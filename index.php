  ...
  <template id="home.html">
    <ons-page id="home">
      <ons-card>
        <center>
          <h3>中文 (Zhong Wen)</h3>
          <img src="logo.png" height="100" width="100">  <p>Version 4.0 (Sencha)</p>
          ...
          <ons-button modifier="large" class="homebtn"  id="dict" onclick="switchpage('dict')">Dictation Mode - <ons-icon size="15px" icon="pencil-alt"></ons-icon>
            ...
            <br><br>
          <a href="monster.php" target="_blank"><ons-button modifier="large" class="homebtn">Character Recognition (PC only) - <ons-icon size="20px" icon="ion-eye"></ons-icon>
          </ons-button></a>
          <br><br>
          ...
          <br><br>
          <a href="shuo.html" target="_blank"><ons-button modifier="large" class="homebtn">Shuo (Pronunciation Tool) - <ons-icon size="20px" icon="ion-volume-high"></ons-icon>
          </ons-button></a>
          ...
          <br><br>
        <a href="pdfgen_hanzi.php"><ons-button modifier="large" class="homebtn">Wifi-Break? Download PDF (Vocabulary) - <ons-icon size="15px" icon="download"></ons-icon>
          </ons-button></a>
            <br><br>
        <a href="pdfgen_gram.php"><ons-button modifier="large" class="homebtn">Wifi-Break? Download PDF (Grammar) - <ons-icon size="15px" icon="download"></ons-icon>
          </ons-button></a>
          <br>
...
<br>
      <center>
        <div class="chip">
            ...
            created by Pi @ LPCUWC/NYUAD, 2018- <?php echo date("Y"); ?>
          </div><br><br>
              ...
              <th>Topic</th>
                      ...
                      if ($result->num_rows > 0) {
                          ...
                          while($row = $result->fetch_assoc()) {
                            ...
                            $wordcount = " <i><span style='color:#3eb489'> - (".getwordnumber($row['topic_id'])." words)</span></i>";
      ...
      <ons-card>
        ...
        <div class="content">
          ...
          <p style="text-align: center;">
              <ons-search-input
                placeholder="Search" id="sensearchbar"
                onchange="sentencesearch(this.value);"
              ></ons-search-input><br><br><ons-button onclick="sentencesearch(document.getElementById('sensearchbar').value);">Search</ons-button>
            </p> <br>
  ...
  <tr>
    ...
    <th> </th><th> </th>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                  $wordcount = " <i><span style='color:#3eb489'> - (".getwordnumber($row['topic_id'])." words)</span></i>";
                  $string = "<tr><td>".$row["topic_name"].$wordcount."</td><td><a style='color:#3eb489;' href='write_learn.php?deck=".$row["topic_id"]."'>[Learn]</td><td><a style='color:#3eb489;' href='write.php?deck=".$row["topic_id"]."'>[Practice]</td></tr>";
                    echo $string;
                }
            } else {
                echo "0 results";
