    ...
    <ons-splitter>
      ...
      <ons-splitter-content>
        <ons-navigator id="navigator">
                  ...
                  <br>
                    <div class="button-bar" style="width:280px;clear: left;">
                        <div class="button-bar__item">
                            <button class="button-bar__button btn-start">Start Dictation</button>
                        </div>
                    </div>
                    <br><br><br>
            ...
            <ons-card id = "card_chin_back">
                <div class="content">
                  ...
                  <br>
                    <div class="button-bar" style="width:280px;clear: left;">
                        <div class="button-bar__item">
                            <button class="button-bar__button btn-know">Next (Q)</button>
                        </div>
                    </div>
                    <br><br><br>
                    <div class="card-stroke" id="writestroke"></div>
            ...
            <br><br>
            <script src="js/dictation.js" charset="utf-8"></script>
